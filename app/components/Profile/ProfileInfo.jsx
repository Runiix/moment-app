...
export default async function ProfileInfo({
   ...
   return (
      <div className="z-10 flex flex-col 2xl:flex-row gap-20 2xl:gap-0 p-10  sm:w-2/3 mx-2 sm:mx-auto border-y border-slate-400 shadow-xl shadow-black rounded-lg">
         <div className="">
