...
export default function Nav({ onSearch }){
    ...
    return(
        ...
        <nav className={navbarBackground ? "fixed w-screen top-0 left-0 p-4 z-10 flex lg:justify-between items-center bg-gray-900" : "fixed w-screen top-0 left-0 p-4 z-10 flex lg:justify-between items-center" } >
            <div className=" flex items-center gap-10 ">
                ...
                <ul className="hidden sm:flex gap-4 lg:gap-10">
                    ...
                    <li>
                        <Link href="/favorites" className="text-slate-100 hover:text-slate-300">My Movies</Link>
                    </li>
                    <li>
                        <Link href="/discover" className="text-slate-100 hover:text-slate-300">Discover</Link>
                    </li>
                </ul>
            </div>
            ...
            <div className="m-2 flex sm:invisible absolute right-10 top-5 hover:cursor-pointer">
                {toggleMenu 
                    ...
                    <div className={`transition-all duration-500 ${toggleMenu ? "scale-100 opacity-100" : "scale-0 opacity-0"} `}>
                        <ul className="absolute text-xl right-0 top-8 p-4 flex flex-col items-center gap-3  text-center bg-gray-900 border border-slate-400 ">
                            ...
                            <li>
                                <NavSearch onSearch={onSearch} show={true} mobile={true} id="mobileSearch"/>
                            </li>
                            <li className="mb-2">
                                <Link href="/home" className="text-slate-100 hover:text-slate-400 border-b border-slate-400">Homepage</Link>
                            </li>
                            <li className="mb-2">
                                <Link href="/movies" className="text-slate-100 hover:text-slate-400 border-b border-slate-400">Movies</Link>
                            </li>
                            <li className="mb-2">
                                <Link href="/favorites" className="text-slate-100 hover:text-slate-400 border-b border-slate-400">My Movies</Link>
                            </li>
                            <li>
                                <Link href="/discover" className="text-slate-100 hover:text-slate-300">Discover</Link>
                            </li>
